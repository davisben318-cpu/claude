...
/**
 * Small set of utility icons only (navigation/interaction affordances).
 * Deliberately no decorative per-service icon set — services are
 * distinguished by number, photography and copy instead.
 */
